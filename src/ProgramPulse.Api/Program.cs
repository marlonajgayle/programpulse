...
using ProgramPulse.Api.Features.Initiatives.Create;
using ProgramPulse.Api.Features.Initiatives.Delete;
using ProgramPulse.Api.Features.Initiatives.GetById;
using ProgramPulse.Api.Features.Initiatives.List;
using ProgramPulse.Api.Features.Initiatives.Update;
...
builder.Services.AddScoped<CreateInitiativeCommandHandler>();
builder.Services.AddScoped<UpdateInitiativeCommandHandler>();
builder.Services.AddScoped<DeleteInitiativeCommandHandler>();
builder.Services.AddScoped<GetInitiativesQueryHandler>();
builder.Services.AddScoped<GetInitiativeByIdQueryHandler>();
...
builder.Services.AddScoped<GetKpisQueryHandler>();
